...
Because of multiple issues with python dependencies not correctly installed during package installation, I removed the automated installation, of the dependencies for now and added them to the installation guide (I will try to solve the issue in the future)
...
## Citation
Daniel Hanhart et al., "ScLinear predicts protein abundance at single-cell resolution"
